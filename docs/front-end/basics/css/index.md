...
![](../../../public/front-end/basics/css/2.png)
...
![](../../../public/front-end/basics/css/6.png)
...
![](../../../public/front-end/basics/css/7.png)
...
![](../../../public/front-end/basics/css/8.png)

**给所有元素默认设置为替代盒模型**：

![](../../../public/front-end/basics/css/9.png)

**获取盒模型宽高的方式**：

![](../../../public/front-end/basics/css/10.png)
...
![](../../../public/front-end/basics/css/13.png)
...
![](../../../public/front-end/basics/css/14.png)
...
![](../../../public/front-end/basics/css/15.png)
...
![](../../../public/front-end/basics/css/16.png)
...
![](../../../public/front-end/basics/css/17.png)
...
![](../../../public/front-end/basics/css/20.png)
...
![](../../../public/front-end/basics/css/21.png)
...
![](../../../public/front-end/basics/css/22.png)

box-shadow 可以用来尝试处理移动端1px的问题（画0.5px的线）：

![](../../../public/front-end/basics/css/23.png)
...
![](../../../public/front-end/basics/css/24.png)

![](../../../public/front-end/basics/css/25.png)
...
![](../../../public/front-end/basics/css/26.png)

**圆锥渐变conic-gradient**，是通过指定渐变中心、旋转角度以及颜色断点列表来实现的。颜色断点放置在渐变圆弧（圆的周长）上，两个颜色断点之间颜色平滑过渡。

![](../../../public/front-end/basics/css/27.png)

![](../../../public/front-end/basics/css/28.png)
...
![](../../../public/front-end/basics/css/36.png)
...
![](../../../public/front-end/basics/css/37.png)
...
![](../../../public/front-end/basics/css/43.png)
...
![](../../../public/front-end/basics/css/48.png)
...
![](../../../public/front-end/basics/css/49.png)
...
![](../../../public/front-end/basics/css/50.png)

### 多行文本内容溢出省略

![](../../../public/front-end/basics/css/51.png)
...
![](../../../public/front-end/basics/css/52.png)
...
![](../../../public/front-end/basics/css/53.png)
...
![](../../../public/front-end/basics/css/54.png)
...
![](../../../public/front-end/basics/css/55.png)

**@font-face（CSS3）**用于指定在线字体，消除对用户电脑字体的依赖。

![](../../../public/front-end/basics/css/56.png)
...
![](../../../public/front-end/basics/css/57.png)
...
![](../../../public/front-end/basics/css/58.png)

![](../../../public/front-end/basics/css/59.png)
...
![](../../../public/front-end/basics/css/60.png)

transform 可以用来尝试处理移动端1px的问题（画0.5px的线）：

![](../../../public/front-end/basics/css/61.png)
...
![](../../../public/front-end/basics/css/62.png)
...
![](../../../public/front-end/basics/css/63.png)
...
![](../../../public/front-end/basics/css/64.png)
...
![](../../../public/front-end/basics/css/65.png)

为了最好地调整网站文本大小，当使用长度值`<length>[em,rem,px]`进行媒体查询时，单位建议使用rem。

![](../../../public/front-end/basics/css/66.png)

![](../../../public/front-end/basics/css/67.png)
...
![](../../../public/front-end/basics/css/68.png)

**利用媒体查询实现自适应**：

![](../../../public/front-end/basics/css/69.png)

**background-image用 image-set() 设置响应式的背景图片**：

![](../../../public/front-end/basics/css/70.png)
...
![](../../../public/front-end/basics/css/71.png)

**Bootstrap中使用媒体查询**：

![](../../../public/front-end/basics/css/72.png)

**媒体查询可以用来尝试处理移动端1px的问题（画0.5px的线）**：

![](../../../public/front-end/basics/css/73.png)
...
![](../../../public/front-end/basics/css/74.png)
...
![](../../../public/front-end/basics/css/75.png)
...
![](../../../public/front-end/basics/css/76.png)
...
![](../../../public/front-end/basics/css/77.png)

**flex-wrap属性**指定 flex 项单行或多行显示，允许在换行条件下控制行的堆叠方向。

![](../../../public/front-end/basics/css/78.png)
...
![](../../../public/front-end/basics/css/79.png)
...
![](../../../public/front-end/basics/css/80.png)
...
![](../../../public/front-end/basics/css/81.png)
...
![](../../../public/front-end/basics/css/82.png)
...
![](../../../public/front-end/basics/css/83.png)
...
![](../../../public/front-end/basics/css/84.png)

![](../../../public/front-end/basics/css/85.png)

##  grid网格布局（CSS3）

CSS 网格是由一系列水平及垂直的线（行与列）构成的二维的布局模式，可以将网格元素（grid项）放置在这些行和列定位的位置上，CSS 网格可用于布局页面主要的区域或小型组件。

![](../../../public/front-end/basics/css/86.png)
...
![](../../../public/front-end/basics/css/87.png)
...
![](../../../public/front-end/basics/css/88.png)
...
![](../../../public/front-end/basics/css/89.png)
...
![](../../../public/front-end/basics/css/90.png)
...
![](../../../public/front-end/basics/css/91.png)
...
![](../../../public/front-end/basics/css/92.png)
...
![](../../../public/front-end/basics/css/93.png)

只需要按行或者列控制布局就用弹性盒子（Flexbox），需要同时按行和列控制布局就用网格（Grid）。弹性盒子从内容出发。网格则从布局入手，先创建网格，然后再把元素放入网格中，或者根据自动放置规则把元素按照网格排列。

grid布局应用：

![](../../../public/front-end/basics/css/94.png)

![](../../../public/front-end/basics/css/95.png)

![](../../../public/front-end/basics/css/96.png)
...
![](../../../public/front-end/basics/css/97.png)
...
![](../../../public/front-end/basics/css/98.png)
...
![](../../../public/front-end/basics/css/99.png)

1. **选择器表达式从右至左解析，最右为关键选择器**，持续左移直到和规则匹配或当不匹配而放弃该规则：

![](../../../public/front-end/basics/css/100.png)
...
![](../../../public/front-end/basics/css/101.png)

**!important相关**：

![](../../../public/front-end/basics/css/102.png)

## 伪类与伪元素

**伪类（:pseudo-class）**是添加到选择器的开头为冒号关键字，用于指定所选元素的特殊状态（比如鼠标悬停、链接状态、表单状态、第几个元素等）。

![](../../../public/front-end/basics/css/103.png)
...
![](../../../public/front-end/basics/css/104.png)

## 滚动条

可以使用以下伪元素选择器去修改基于 webkit 的浏览器的滚动条样式（即firefox不支持）：

![](../../../public/front-end/basics/css/105.png)

## 交互

touch-action 属性用于设置触摸屏用户如何操纵元素的区域（例如，浏览器内置的缩放功能）。

![](../../../public/front-end/basics/css/106.png)
...
![](../../../public/front-end/basics/css/107.png)
...
![](../../../public/front-end/basics/css/108.png)
...
3. transition-timing-function：
    ...
    3. **阶跃函数`steps(n, <jumpterm>)`** 定义了将输出值域分为等距步长的阶跃函数，也称为阶梯函数，比如时钟转动，按照 n 个定格在过渡中显示动画迭代，每个定格等长时间显示，每个停留点的持续时间为总动画时间的 1/n。具体如何跳跃取决于跳跃项 `<jumpterm>`。例如，如果 n 为 5，则有 5 个步骤：
        ...
        ![](../../../public/front-end/basics/css/109.png)
...
![](../../../public/front-end/basics/css/110.png)
...
![](../../../public/front-end/basics/css/111.png)

![](../../../public/front-end/basics/css/112.png)

![](../../../public/front-end/basics/css/113.png)
...
![](../../../public/front-end/basics/css/114.png)
...
![](../../../public/front-end/basics/css/115.png)
...
![](../../../public/front-end/basics/css/116.png)
...
![](../../../public/front-end/basics/css/117.png)

定位：

![](../../../public/front-end/basics/css/118.png)

盒模型：

![](../../../public/front-end/basics/css/119.png)

排版：

![](../../../public/front-end/basics/css/120.png)

可访问性与交互：

![](../../../public/front-end/basics/css/121.png)

视觉：

![](../../../public/front-end/basics/css/122.png)

动画：

![](../../../public/front-end/basics/css/123.png)
...
![](../../../public/front-end/basics/css/124.png)

## 图片

![](../../../public/front-end/basics/css/125.png)

**CSS Sprites（雪碧图）**：将多个小图片合并成一张图，通过CSS的background-position来定位展示需要显示的图片部分。优缺点如下：

![](../../../public/front-end/basics/css/126.png)
...
![](../../../public/front-end/basics/css/127.png)
...
![](../../../public/front-end/basics/css/128.png)

如果图片使用CDN，也就可能是CDN存在节点覆盖不全的问题，使得DNS查询超时导致图片加载失败，可以通过切换domain来尝试：

![](../../../public/front-end/basics/css/129.png)
...
![](../../../public/front-end/basics/css/130.png)
...
![](../../../public/front-end/basics/css/131.png)

![](../../../public/front-end/basics/css/132.png)

**混合mixin**，可理解为可复用的样式片段。mixin在编译后是否在CSS中输出取决于定义是否带括号。

![](../../../public/front-end/basics/css/133.png)

![](../../../public/front-end/basics/css/134.png)

@media 或 @supports 等 at 规则能以与选择器相同的方式嵌套。编译后，at 规则位于顶部，并且与同一规则集中的其他元素的相对顺序保持不变。这称为冒泡。

![](../../../public/front-end/basics/css/135.png)

**函数（Function）**：包括多种转换颜色、操作字符串、进行数学运算、参数检测的函数。

![](../../../public/front-end/basics/css/136.png)
...
![](../../../public/front-end/basics/css/137.png)

![](../../../public/front-end/basics/css/138.png)

## 设备与视口

设备屏幕尺寸是指屏幕的对角线长度。像素是计算机屏幕能显示一种特定颜色的最小区域，分为设备像素和逻辑像素。

![](../../../public/front-end/basics/css/139.png)
...
![](../../../public/front-end/basics/css/140.png)
...
![](../../../public/front-end/basics/css/141.png)
...
![](../../../public/front-end/basics/css/142.png)

## CSS换肤方案

![](../../../public/front-end/basics/css/143.png)
...
![](../../../public/front-end/basics/css/144.png)

**实现示例**：

![](../../../public/front-end/basics/css/145.png)
...
![](../../../public/front-end/basics/css/146.png)

![](../../../public/front-end/basics/css/147.png)
...
![](../../../public/front-end/basics/css/148.png)

![](../../../public/front-end/basics/css/149.png)
...
![](../../../public/front-end/basics/css/150.png)

**如何使用**：

![](../../../public/front-end/basics/css/151.png)

或者通过 Stylelint VSCode 编辑器插件，代码编写过程中提示颜色字面量需要用颜色变量来替代，可设置保存时自动替换。

![](../../../public/front-end/basics/css/152.png)
...
![](../../../public/front-end/basics/css/153.png)
...
![](../../../public/front-end/basics/css/154.png)
...
![](../../../public/front-end/basics/css/155.png)
...
```
![Alt text](../../../public/front-end/basics/css/image-1.png)
...
```
![Alt text](../../../public/front-end/basics/css/image-2.png)
...
```
![Alt text](../../../public/front-end/basics/css/image-3.png)

**等边三角形**：通过设置border宽度比为：指定方向 / 非指定方向 = ![Alt text](../../../public/front-end/basics/css/image.png) 即可。
...
```
![Alt text](../../../public/front-end/basics/css/image-4.png)
...
![Alt text](../../../public/front-end/basics/css/image-5.png)
...
![Alt text](../../../public/front-end/basics/css/image-6.png)
...
![Alt text](../../../public/front-end/basics/css/image-7.png)
...
![Alt text](../../../public/front-end/basics/css/image-8.png)
...
![Alt text](../../../public/front-end/basics/css/image-9.png)
...
![Alt text](../../../public/front-end/basics/css/image-10.png)
...
![Alt text](../../../public/front-end/basics/css/image-11.png)
...
![Alt text](../../../public/front-end/basics/css/image-13.png)
...
![Alt text](../../../public/front-end/basics/css/image-12.png)
...
![Alt text](../../../public/front-end/basics/css/image-15.png)
...
![Alt text](../../../public/front-end/basics/css/image-16.png)
...
![Alt text](../../../public/front-end/basics/css/image-17.png)
...
![Alt text](../../../public/front-end/basics/css/image-18.png)
...
![Alt text](../../../public/front-end/basics/css/image-19.png)